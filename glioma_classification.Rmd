...
```{r}
# Data Loading
gli_data <- read.csv("/Users/tarun/Desktop/Glioma_classification/glioma+grading+clinical+and+mutation+features+dataset/TCGA_GBM_LGG_Mutations_all.csv")

#Preprocessed data where all the factors are converted to numeric values and the data set has been cleaned
gli_data_num <- read.csv("/Users/tarun/Desktop/Glioma_classification/glioma+grading+clinical+and+mutation+features+dataset/TCGA_InfoWithGrade.csv")
```
# Data Exploration
